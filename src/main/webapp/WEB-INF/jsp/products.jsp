...
.stock-ok  { background: rgba(34,197,94,0.12);  color: #4ade80; border: 1px solid rgba(34,197,94,0.2); }
.stock-ok::before  { background: #4ade80; }
.stock-low { background: rgba(234,179,8,0.12);  color: #fbbf24; border: 1px solid rgba(234,179,8,0.2); }
.stock-low::before { background: #fbbf24; }
.stock-out { background: rgba(239,68,68,0.12);  color: #f87171; border: 1px solid rgba(239,68,68,0.2); }
...
.edit-icon:hover { background: var(--accent-glow); border-color: rgba(59,130,246,0.3); color: var(--accent); }
...
#confirm-box {
    ...
    border-radius: 14px; padding: 32px; width: 360px; max-width: 92vw;
...
.btn-confirm-cancel { flex:1; padding:11px; background:rgba(255,255,255,0.06); color:var(--text-dim); border:1px solid var(--border); border-radius:var(--radius-sm); cursor:pointer; font-family:'Syne',sans-serif; font-size:13px; font-weight:700; transition:all 0.15s; }
.btn-confirm-cancel:hover { background:rgba(255,255,255,0.10); color:var(--text); }
.btn-confirm-ok { flex:1; padding:11px; background:var(--danger); color:white; border:none; border-radius:var(--radius-sm); cursor:pointer; font-family:'Syne',sans-serif; font-size:13px; font-weight:700; transition:all 0.15s; }
...
.modal-content textarea:focus { border-color: var(--accent); box-shadow: 0 0 0 3px var(--accent-glow); }
...
.modal-spinner {
    ...
    background: rgba(8,12,20,0.7); border-radius: 14px;
    align-items: center; justify-content: center;
...
.price-cell { font-family: 'DM Mono', monospace; font-size: 13px; font-weight: 500; color: var(--text); }
.sku-cell   { font-family: 'DM Mono', monospace; font-size: 11px; color: var(--text-muted); letter-spacing: 0.04em; }
</style>
</head>
    ...
    <div class="modal-content">
        ...
        <div class="form-row">
            <div class="form-group">
                <label>SKU</label>
                <input type="text" id="addSku" placeholder="SKU-001">
            </div>
            <div class="form-group">
                <label>Category</label>
                <input type="text" id="addCategory" placeholder="Electronics">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                <label>Price (₹)</label>
                <input type="number" id="addPrice" placeholder="0.00" min="0" step="0.01">
            </div>
            <div class="form-group">
                <label>Stock Quantity</label>
                <input type="number" id="addStock" placeholder="0" min="0" value="0">
            </div>
        </div>
    ...
    const table = $('#productsTable').DataTable({
        ...
        columns: [
            { data:null, orderable:false, render:(d,t,r,meta) =>
                '<span style="font-family:\'DM Mono\',monospace;font-size:11px;color:var(--text-muted)">'+(meta.settings._iDisplayStart+meta.row+1)+'</span>'
            },
            { data:'sku', render:(v) =>
            ...
            { data:'category', render:(v) => {
                ...
                return '<span style="display:inline-block;padding:3px 10px;border-radius:999px;background:rgba(255,255,255,0.05);border:1px solid var(--border-2);font-size:11px;font-family:\'DM Mono\',monospace;color:var(--text-dim)">'+v+'</span>';
            }},
